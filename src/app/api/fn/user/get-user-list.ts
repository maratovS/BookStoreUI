...
export function getUserList(http: HttpClient, rootUrl: string, params?: GetUserList$Params, context?: HttpContext): Observable<StrictHttpResponse<PageDto & {
