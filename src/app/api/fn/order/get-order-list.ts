...
export function getOrderList(http: HttpClient, rootUrl: string, params?: GetOrderList$Params, context?: HttpContext): Observable<StrictHttpResponse<PageDto & {
